											...
											<div class="row g-5 align-items-end mb-5">
												<div class="col-lg-6 wow fadeInUp treat_title title1" data-wow-delay="0.1s">
													<div class="border-start border-5 border-primary ps-4">
														<h6 class="text-body text-uppercase mb-2 first-title">
															Treatment Subject
														</h6>
          ...
          <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
            ...
            <div class="row gy-5 gx-4">
              ...
              <div class="col-sm-6 wow fadeIn" data-wow-delay="0.2s">
                ...
                <span
                  >비뇨기는 혈액내 노폐물들을 신장을 통해 걸러내어 소변의 형태로 몸밖으로 배출하는 역할을 하게 됩니다. 소변이 생성, 저장되고 몸 밖으로 나가는 통로인 요로계 장기들은 신장, 요관, 방광, 요도 등으로 구성이 됩니다. 비뇨기과에서 다루는 질병의 증상은 배뇨장애, 혈뇨, 핍뇨, 다뇨등 특징적인 증상들과 침울, 식욕감퇴, 통증 , 체중 감소, 구토나 설사등의 비특이적인 증상들을 동반할수도 있다.</span
                >
              </div>
