...
<body>
	...
	<div id="dc_container">
		<div id="tit_detail">
			<div>${petdetail.a_name }</div>
			<div>${petdetail.board_date }</div>
		</div>
		<div id="dc_main">
		
			<div id="dc_img">
				<c:if test="${petdetail.board_file ne null}">
					<img alt="img" src="./resources/upload/${petdetail.board_file }">
				</c:if>
			</div>
		
				<div id="dc_text">
					${petdetail.board_content }
				</div>
		</div>
	</div>	
		<div id="dc_btn">
